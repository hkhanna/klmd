...
class StyleMapping:
    ...
    These style names must exist in the template document. The template
    controls all formatting including any numbering associated with heading styles.
    """
...
class DocxConfig:
    ...
    A template is required. The template controls all styling including
    fonts, spacing, and any numbering associated with heading styles.
    """
